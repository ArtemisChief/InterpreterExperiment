...
//    private final  Font DEFAULT_FONT = new Font(Font.MONOSPACED, Font.PLAIN, 11);
    private final  Font DEFAULT_FONT = new Font("微软雅黑",0,13);
    public final Color DEFAULT_BACKGROUD = new Color(240, 240, 240);
    public final Color DEFAULT_FOREGROUD = new Color(153, 153, 153);
